...
const Auth = () => {
    ...
    return (
        <div className="auth-root">
            <div className="ambient-holo-bg"></div>
            
            <div className="auth-card">
                <header className="auth-header">
                    <h1 className="auth-title">LINKUP</h1>
                    <div className="auth-subtitle">
                        [Access Terminal]<span className="blink-cursor">_</span>
                    </div>
                </header>
                ...
                <div className="auth-divider">or enter manually</div>
                ...
                <form onSubmit={handleEmailAuth}>
                    ...
                    <button type="submit" className="auth-submit-btn" disabled={loading}>
                        {loading ? <i className="fas fa-circle-notch fa-spin"></i> : (isSignUp ? 'Initialize Account' : 'Access Network')}
                    </button>
                </form>

                <div className="auth-footer">
                    {isSignUp ? 'Already on the network?' : 'New to the network?'}
